...
- Осталось: Search Console (нужен логин владельца) + тест входа в админку блога на новом домене (если GitHub OAuth не пустит — проверить ALLOWED_DOMAINS в Cloudflare-воркере)

## Продающий копирайт (11.08.2026)
...
- В 16 карточках кейсов — зелёные строки результата (▸)
